    ...
    <div className="bg-body-background" >
      <div className="relative overflow-hidden bg-home-background bg-cover bg-no-repeat bg-top pb-24" >
        <div className="flex flex-col items-center max-w-screen-2xl mx-auto" >
          ...
          <div className="code-box-shape flex flex-col items-center my-14">
            <div className="code-box-shape flex flex-col items-center font-medium text-center text-6xl text-white mx-auto my-8" >BET Token</div>
            <div className="code-box-shape flex flex-col items-center font-medium text-center text-3xl text-white mx-auto my-8 leading-loose w-11/12">
            ...
            <div className="code-box-shape flex flex-col items-center text-center rounded-full bg-button-background hover:bg-opacity-75 mx-auto my-8 py-4 px-12 font-medium text-2xl shadow-lg" onClick={() => setVisible(true)}>Deposit to get BET Tokens</div>
          </div>
